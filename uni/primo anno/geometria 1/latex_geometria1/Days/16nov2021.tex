In\marginnote{16 nov 2021} generale $ V $ non ha un'orientazione canonica, ma nei casi in cui $ V $ abbia una base canonica $ \mathscr{B}_0 $ 
...
\dimostrazione{kjkjhjjdjdj}{
    \begin{enumerate}
        ...
        \item $ (W^{\bot})^{\bot} $: \[
            v \in (W^{\bot})^{\bot} \,\iff\, v \cdot z = 0 \,\forall\, z \in W^{\bot}\,\iff\, v \in W\qedd
        \]
    \end{enumerate}
}
...
\dimostrazioneprop{jjdijijijiij}{
    Dimostrazione per esercizio %ESERCIZIO fare dimostrazione
}
...
\esercizio{
    ...
    \[
        \dim \mathcal{A}(\R^{n,n}) + \dim \mathcal{S}(\R^{n,n}) = n^{2}%ESERCIZIO calcolarlo per esercizio
        = \dim  \R^{n,n}
    \] 

...
\esempio{
    Sia $ \xi:\R^{2}\times \R^{2} \to \R$ la forma bilineare \[
        \xi(x,y)=3x_1x_2-2x_2y_2
    \]
    Cerco $ M^{ \mathscr{B}}(\xi) $, dove $ \mathscr{B}=\{e_1,e_2\} $ è la base canonica di $ \R^{2} $. \[
        M^{ \mathscr{B}}(\xi)=\begin{pmatrix}
            \xi(e_1,e_1) & \xi(e_1,e_2)\\
            \xi(e_2,e_1) & \xi(e_2,e_2)
...
\esercizio{
    ...
    Dimostrare l'affermazione %ESERCIZIO risolvere
}{}

% ATOD creare pagina singola + obsidian
...
\begin{enumerate}
    ...
    \todo{Scrivere la divisione polinomiale}
    ...
    \item Trovo la base ortonormale: $ \{e_1, e_2, e_3\} $ è base ortonormale di autovettori di $ A $. Quindi \[
        ...
        \in O(3)
    \]
    \todo{Manca matrice (al posto di $ \star $)}
...
\todo{Mancano una osservazione e una definizione}
...
\dimostrazione{sdofijoijoijoijoidsf}{
    \begin{itemize}
        \item [(\textit{i}) $ \implies $ (\textit{ii})] Sia $ A \in \C^{n,n} $, tale che $ \exists P \in U(x) $ tale che \[
            P^{-1} A P =D
        \] con $ D $ diagonale.

        $ A=PDP^{-1} $ 
        
        $\implies$ $ \overline{A}=\overline{P}\,\overline{D}\,\overline{P}^{-1} $ 
        
        $\implies$ $\displaystyle \null^{t}\overline{A} = \underset{=P}{\null^{t}\overline{P}^{-1}}\,\overline{D}\,\underset{=P^{-1}}{\null^{t}\overline{P}}$
        
        $\implies$ $ \null^{t}\overline{A}=P\,\overline{D}\, P^{-1} $

        Si ha quindi che \begin{align}
            A\null^{t}\overline{A}&=PDP^{-1}\,P\,\overline{D}\, P^{-1}=PD\,\overline{D}\, P^{-1}\label{etero1}\\
            \null^{t}\overline{A}A&=P\,\overline{D}\, P^{-1}\,PDP^{-1}=P\,\overline{D}\,DP^{-1}\label{etero2}
        \end{align}
        Poiché $ D $ e $ \overline{D} $ commutano, \eqref{etero1} e \eqref{etero2} sono uguali, e 
        
        $\implies$ $ A $ e $ \null^{t}\overline{A} $ commutano.\qed
    \end{itemize}
}

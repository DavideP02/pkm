\teorema[(legame limite successione e sottosuccessione)]{ddfsfsfsdfs}{
    Consideriamo\marginnote{15 nov 2021} $ \{a_{n} \}_{n=0}^\infty $, $ l \in \R* $, 
    
    \begin{gather*}
        \lim_{n\to \infty} a_{n}  = l\\
    \iff \end{gather*}
    ogni sottosuccessione di $a_{n}$ ammette una sottosuccessione che tende a $l$
}
\dimostrazione{ddfsfsfsdfs}{
    \begin{itemize}
        \item [``$\implies$''] La prima implicazione è vera, pertanto \[
            \forall\,V(l) \quad\exists \,\overline{n}\,|\quad \forall\,n\ge \overline{n}\quad a_{n} \in V(l) 
        \] 
        Sia $ n\to k_{n}$ crescente, e $ b_{n}=a_{k_{n} } $, allora \[
            \exists\, \overline{\overline{n}} \:|\quad\forall\,n\ge \overline{\overline{n}}:\quad  k_{n} \ge \overline{n}   
        \]
        allora $ b_{n}=a_{k_{n} } \in V(l) $.

        Dunque \[
            \forall\,V(l)\quad \exists\,\overline{\overline{n}} \in \N \,\tc\quad \forall\,n > \overline{\overline{n}}:\quad b_{n} \in V(l)
        \] 
        ...
        \item [``$\impliedby$''] Assumiamo vera la seconda implicazione, e procedendo per assurdo assumiamo vera la negazione della prima implicazione, ossia \[
            \forall\, V(l)\quad \forall\,n \in \N\quad \exists\, n'\ge n \,|\: a_{n'} \notin V(l) 
        \]
...
$ \{a_{k} \}_{k=0}^\infty $ a valori vettoriali è convergente a $ l \in \R^{n} $ se \[
    \forall\, \varepsilon>0\quad \exists \overline{k} \in \N \:\big|\quad\forall\, k\ge\overline{k}:\,\hspace{-1em}\underset{\big(\sum_{j=1}^{n}(a_{j}^{k}-l )^{2}\big)^{1/2}}{\underbrace{|a_{k} - l |}}\hspace{-2em}< \varepsilon
\]

$ \{a_{k} \}_{k=0}^\infty $ a valori vettoriali è divergente a $ l \in \R^{n} $ se \[
    \forall\, M>0\quad \exists\, \overline{k} \in \N \:\big|\quad\forall\, k\ge\overline{k}:\,|a_{k}|>M
\]
...
\dimostrazioneprop{asgdfgdffger}{
    \begin{itemize}
        \item [caso 1.] $ y \in \R^{n} $: $ y \in E' $, si ha \[
            \forall\, r>0 \quad\exists\, x \in E, x \neq y\,\big|\: x \in B_{r}(y) 
        \]

        Consideriamo $ k=1,2,3,\dots $; possiamo determinare $ x_{k} \in E $, con $ x_{k}\neq y$ e $ x_{k} \in B_{1/k}(y) $

        Abbiamo ottenuto una successione $ \{x_{k} \}_{k=0}^\infty $ a valori in $ E $ tale che \[\forall\,\varepsilon>0\quad\exists\, \overline{k} \,|\quad \forall\, k\ge \overline{k}:\quad x_{k} \in B_{1/k}(y)\subset B_{{1/\overline{k}}}(y) \subset B_{\varepsilon}(y)\]

        Allora $ x_{k} \xrightarrow{k\to +\infty} y \displaystyle  $, $ x_{k}\neq y  $
        \item [caso 2.] $ y =\infty $, $ y \in E' $
        \[
            \forall\, M >0 \quad\exists\, x \in E:\: |x| > M
        \]

        Per $ k=1,2,3,\dots $ consideriamo $ x_{k} \in E $, con $ |x_{k}|\ge k$ allora \[
            \forall\, \varepsilon>0 \quad\exists\, \overline{k} \in \N \,\big|\: \forall\, k \ge \overline{k}:\, |x_{k}| \ge k \ge \overline{k}>M 
        \] 
...
\definizione{}{
    Sia $ \{a_{k} \}_{k=0}^\infty $ a valori in $ \R^{n} $. Questa successione è detta \textit{successione di Cauchy} (o successione fondamentale) se \[
        \forall\, \varepsilon>0\quad \exists\,\overline{k} \in \N\,\big|\: \forall\, k,m\ge \overline{k}:\, |a_{k}-a_{m}|< \varepsilon  
    \]

    O, equivalentemente
    \[
        \forall\, \varepsilon>0\quad \exists\, \overline{k} \in \N\,\big|\: \forall\,k>\overline{k}\hspace{1em} \forall\, p \in \N:\: |a_{k}-a_{k+p}|< \varepsilon    
    \]

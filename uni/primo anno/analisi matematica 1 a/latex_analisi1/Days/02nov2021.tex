\subsection{Limiti delle successioni}\marginnote{2 nov 2021}
...
Un predicato $ P(n) $ è verificato definitivamente se 
\[
    \exists\, \overline{n} \,\tc\quad \forall\, n\ge \overline{n}\quad P(n)\text{ è vero}
\]
...
\dimostrazione{bern}{
    ...
    Allora per induzione \[
        \forall\, n \in \N\qquad (1+x)^{n}\ge 1+nx \quad\land\quad x>-1\qedd
    \]
}
...
Progressione geometrica \[
    ...
    \]
    \begin{itemize}
        \item se $q>1$, $q=1+p$ con $p>0$
            \[q^n = (1+p)^n \ge 1+n\,p\] per la disuguaglianza di Bernoulli

            $ 1+np \xrightarrow[n \to +\infty]{} +\infty$

            Per confronto \[
                \lim_{n\to + \infty} q^n=+ \infty
            \]
        \item se $ q=1 $ allora $ q^n = 1 $ $ \forall n $
        \[
            \lim_{n\to + \infty} q^n=1
        \]
        \item se $ -1<q<1 $ $ \iff $ $ |q|<1 $ 
        ...
        \item $ q<-1 $ \[
            q^n=(-1)^n|q|^n
        \]
        ma $ |q|>1 $ quindi $ |q|^n \xrightarrow[n\to + \infty]{}+ \infty $, e quindi $ q^n $ è irregolare non limitata
    \end{itemize}
    Riassumendo \[
    q^n\begin{cases}
...
\dimostrazione{rel}{
    \begin{itemize}
        \item [(A) $\implies$ (B)] Sappiamo che $\displaystyle \lim_{x\to x_{0} } f(x) =l $ ovvero \begin{equation}
            \forall\, V(l)\quad \exists\, U(x_{0} ) \,|\, x \in U\, \land \,x \in V \,\land\, x \neq x_{0} \,\implies\, f(x) \in V(l)\label{eq1}
        \end{equation}
        ...
        Concludendo, unendo \eqref{eq1} e \eqref{eq2}: \[
            \forall\, V(l)\quad \exists\, \overline{n} \in \N \,|\, \forall\, n > \overline{n}\quad f(a_{n} ) \in V(l)
        \]
        ossia
        \[
...
\subsubsection{Confronti tra infiniti}
\begin{enumerate}

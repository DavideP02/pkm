...
\esempio{}{
    ...
    \todo{Manca la fine di questo esempio}
}
...
\dimostrazione{contederiv}{
    $ f $ continua in $ x_0 $ \[
        \iff \lim_{h\to 0} f(x_0+h) = f(x_0) \iff \lim_{h\to 0} \bigl(f(x_0+h)-f(x_0)\bigr) =0
    \]
    Dimostriamo che vale se $ f $ è derivabile in $ x_0 $
   \[
        \lim_{h\to 0} \bigl(f(x_0)-f(x_0)\bigr) =\\ \lim_{h\to 0} \parentesi{\to f'(x_0) \in \R}{\frac{f(x_0+h)-f(x_0)}{h}} \cdot h = 0\qedd\]
}
...
%ATOD creare pdf e pagina obsidian
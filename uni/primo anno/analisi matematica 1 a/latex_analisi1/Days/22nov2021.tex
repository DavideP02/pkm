\esempio{\marginnote{22 nov 2021}
    ...
    Entrambe le funzioni sono continue in $ (0,1) $: $ \forall\,x_0 \in (0,1) $, \[ \forall\, \varepsilon>0\quad \exists\,\delta=\delta( \varepsilon, x_0)>0 \,\tc\, |x-x_0|< \delta\quad \begin{cases}
...
\definizione{}{
    ...
    \end{align*} con $ D \subseteq \R $, diciamo che $ f $ è \textit{uniformemente continua su} $ D $ se \[
        \forall\, \varepsilon >0\quad\exists\, \delta=\delta( \varepsilon)>0\,\tc\, \forall\,x_0, x \in D \quad |x-x_0|<\delta \,\implies\, |f(x)-f(x_0)|< \varepsilon
    \]
}
...
\esercizio{
    ...
    Verificare per esercizio %ESERCIZIO risolvere
}{}
...
\esempi{}{
    \begin{enumerate}
        ...
        \item $ A=\{\cos k \pi/2\}_{k \in \Z}=\{0, 1, -1\} $ \todo{Manca un pezzo}
    ...
    \begin{itemize}
        ...
        \item [``$\implies$''] $ K $ compatto.
            \begin{enumerate}
                ...
                Sia $ \{x_{k} \}_{k=0}^\infty $ la successione così ottenuta. $\implies$ \[\forall\, \varepsilon>0\quad\exists\, \overline{k} \,|\, \forall\, k \ge \overline{k}\quad x_{k} \in B_{1/k}(z) \subseteq B_{1/\overline{k}}(z) \subseteq B_{ \varepsilon}(z)   \] dunque $ x_{k} \xrightarrow{k\to +\infty} z \in \delta K \displaystyle $
...
Diciamo che $ f $ è continua su $ D $ se \[
    \forall\, x_0 \in D\quad \forall\, \varepsilon>0\quad\exists\, \delta >0 \,\tc\, \forall\, x \in D\quad |x-x_0|<\delta \,\implies\, |f(x)-f(x_0)|< \varepsilon
\]
